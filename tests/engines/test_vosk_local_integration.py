...
def test_vosk_local_full_lifecycle():
    ...
    with patch('dictatux.engines.vosk_local.runner.VoskInferenceBackend') as mock_backend_class, \
         patch('dictatux.engines.vosk_local.runner.AudioPipeline') as mock_pipeline_class:
