...
def test_vad_result_enum():
    ...
    from dictatux.vad_processor import VADResult
...
def test_rms_vad_detects_silence():
    ...
    from dictatux.vad_processor import RMSVADProcessor, VADResult
...
def test_vad_state_machine_silence_timeout():
    ...
    vad = RMSVADProcessor(
        threshold=0.5, min_speech_duration_ms=0, silence_timeout_ms=50
    )
