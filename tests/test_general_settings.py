...
def test_general_settings_defaults():
    ...
    from dictatux.general_settings import GeneralSettings
...
def test_general_settings_field_metadata():
    ...
    assert precommand_field.metadata['validate'] == 'dictatux.validators:validate_command_exists'
    ...
    assert postcommand_field.metadata['validate'] == 'dictatux.validators:validate_command_exists'
