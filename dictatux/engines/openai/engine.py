...
class OpenAIRealtimePlugin(EnginePlugin):
    ...
    def apply_to_settings(
        self, app_settings: "Settings", engine_settings: OpenAISettings
    ) -> None:
        ...
        app_settings.openaiVadSilenceDurationMs = (
    ...
    def load_settings_from_app(self, app_settings: "Settings") -> OpenAISettings:
        ...
        return OpenAISettings(
            ...
            api_key=app_settings.openaiApiKey,
            model=app_settings.openaiModel,
            api_version=app_settings.openaiApiVersion,
            sample_rate=app_settings.openaiSampleRate,
            channels=app_settings.openaiChannels,
            vad_enabled=app_settings.openaiVadEnabled,
            vad_threshold=app_settings.openaiVadThreshold,
