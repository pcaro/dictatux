...
from dictatux.stt_factory import get_available_engines, describe_engine
from dictatux.engine_plugin import get_plugin
        ...
        if not settings.models:
            return CliExit(
                ...
                stdout=(
                    ...
                    "Use the GUI (dictatux) to download or import models\n"
                ),
            )
