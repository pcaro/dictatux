...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("../icons/dictatux/scalable/micro.svg"),
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.versionLineEdit
        )
        self.sizeLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        self.sizeLabel.setObjectName("sizeLabel")
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sizeLabel
        )
        ...
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sizeLineEdit
        )
        self.languageLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        self.languageLabel.setObjectName("languageLabel")
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.languageLabel
        )
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.languageLineEdit
        )
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(
            _translate(
                "Dialog",
                '<html><head/><body><p><span style=" font-weight:600;">Select a custom model</span></p></body></html>',
            )
        )
        ...
        self.nameLabel.setToolTip(
            _translate(
                "Dialog",
                "<html><head/><body><p>Give a name to your model</p></body></html>",
            )
        )
        self.nameLabel.setText(_translate("Dialog", "Name"))
        self.classLabel.setToolTip(
            _translate(
                "Dialog",
                "<html><head/><body><p>Indicate a class to your model like small, medium or big</p></body></html>",
            )
        )
        ...
        self.versionLabel.setToolTip(
            _translate(
                "Dialog",
                "<html><head/><body><p>Give a version number to your model</p></body></html>",
            )
        )
