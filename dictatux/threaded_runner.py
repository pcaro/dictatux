...
from dictatux.audio_pipeline import AudioPipeline
from dictatux.text_formatter import TextFormatter
from dictatux.stt_engine import STTController
...
class ThreadedInferenceRunner:
    ...
    def _process_audio(self, audio: bytes) -> None:
        ...
        if not self._backend.is_loaded:
            logging.warning(
                "Inference requested but model not loaded yet. Skipping segment."
            )
