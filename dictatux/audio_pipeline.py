...
from dictatux.vad_processor import VADProcessor, VADResult
...
class AudioCapture:
    ...
    def open(self) -> None:
        ...
        self._recorder = AudioRecorder(
            sample_rate=self._sample_rate, device=self._device
        )
            ...
            try:
                ...
                if result == VADResult.SPEECH_START:
                    ...
                    if speech_start_time is not None:
                        ...
                        logging.debug(
                            f"VAD: Speech ended, segment length: {len(segment)} bytes"
                        )
